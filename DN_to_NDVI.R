...
setwd('D:/SHARE/CURSOS/LUMA-GIS/RS/13. Data integration and multiple images/exercises/output')
ndvi.clst <- read.csv('NDVI_climate_stations_2.txt', sep = ',')
...
require(raster)
require(sf)
r.1 <- raster("D:\\SHARE\\CURSOS\\LUMA-GIS\\RS\\13. Data integration and multiple images\\Data_for_exercise\\NOAA_ASIA.idb\\c_1\\r_1.img")
lu <- st_read("D:\\SHARE\\CURSOS\\LUMA-GIS\\RS\\13. Data integration and multiple images\\Data_for_exercise\\LandUse_1992.shp")
cl <- st_read("climate_stations.shp")

lu.cl.inter <- st_intersection(lu, cl)
st_geometry(lu.cl.inter) <- NULL
lu.cl.inter[lu.cl.inter$station_na==name.st,]$LU_NAME
